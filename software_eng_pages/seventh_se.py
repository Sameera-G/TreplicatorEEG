...
class MainWindow(tk.Tk):
    def __init__(self, selected_role, user_id, firebase):
        ...
        title_label = tk.Label(title_frame, text="Code Testing (Positive Test Cases) - Arrange the testing Code Snippets in Correct Order", fg="white", bg="black", font=("Arial", 16, "bold"))
        ...
        # Load text from file
        self.load_text_from_file("software_eng_pages/paragraphs_se/seventh_page_positive_test.txt", 0.07, 0.25)
    ...
    def goToNextPage(self):
        ...
        main_data = {
            'Accuracy_Percentage_code_testing_Positive': percentage,
            # Add more fields as needed
        }

        # Data for the nested "times" collection
        time_data = {
            'Time_taken_to_answer_code_testing_Positive': time_taken,
        }
